...
const useSoundManager = () => {
  ...
  const initSounds = useCallback(async (onProgress) => {
    ...
    const soundNames = Object.keys(soundPaths);`n    let loadedCount = 0;`n    totalSoundsRef.current = soundNames.length;`n    `n    for (const [name, path] of Object.entries(soundPaths)) {
      try {
